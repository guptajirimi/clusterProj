...
public class PoRegisterFB {
	...
	private String strDrugClassCode = "0";
	private String strDrugClassName = "";
	...
	private String strWithProgramme = "0";
	private String strWithProgFlg = "0";
	private String strPath = "";
	private String strIndentItemList = "";
	private String strReqDate = "";
	private String strUserName = "";
	private String strTableWidth = "";
	private String strProgrammeId = "0";
	private String strProgrammeNameCombo = "";
	private String strFundingSourceCombo = "";
	private String strFundSourceId = "0";
	...
	public String getStrPurchaseOrderRptData() {
		return strPurchaseOrderRptData;
	}
	public void setStrPurchaseOrderRptData(String strPurchaseOrderRptData) {
		this.strPurchaseOrderRptData = strPurchaseOrderRptData;
	}
	...
	public String getStrWithProgramme() {
		return strWithProgramme;
	}
	public void setStrWithProgramme(String strWithProgramme) {
		this.strWithProgramme = strWithProgramme;
	}
	public String getStrWithProgFlg() {
		return strWithProgFlg;
	}
	public void setStrWithProgFlg(String strWithProgFlg) {
		this.strWithProgFlg = strWithProgFlg;
	}
	...
	public String getStrProgrammeNameCombo() {
		return strProgrammeNameCombo;
	}
	public void setStrProgrammeNameCombo(String strProgrammeNameCombo) {
		this.strProgrammeNameCombo = strProgrammeNameCombo;
	}
	public String getStrFundingSourceCombo() {
		return strFundingSourceCombo;
	}
	public void setStrFundingSourceCombo(String strFundingSourceCombo) {
		this.strFundingSourceCombo = strFundingSourceCombo;
	}
	public String getStrFundSourceId() {
		return strFundSourceId;
	}
	public void setStrFundSourceId(String strFundSourceId) {
		this.strFundSourceId = strFundSourceId;
	}
